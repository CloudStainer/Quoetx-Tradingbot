...
import asyncio
import subfunction.handle_message as handle_message
...
async def run_main_script(user_input):
    async with async_playwright() as p:
        ...
        try:
            ...
            await trade_page.expose_function('notifyBackend', lambda event, message: handle_message.main_script(trade_page, event, message))
            ...
            #await trade_page.evaluate(common.file_get_contents('bypass.js')+common.file_get_contents('wsHook.js'))
